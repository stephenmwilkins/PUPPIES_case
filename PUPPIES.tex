...
Like \emph{Hubble} before it, \emph{Webb} has the capability to use a second instrument in parallel to prime observations. This allows us to obtain observations across many independent locations on the sky virtually for free. \emph{Hubble} pure parallel programmes including HIPPIES (Yan et al., 2011) and BoRG (Trenti et al., 2011) were instrumental to providing constraints on the bright-end of the high-redshift $z>6$ luminosity function. Based on the planned GTO and ERS programs it is anticipated that the pure parallel opportunities available to \emph{Webb} will cover a wider range of exposure times and thus potential depths. 

\vspace{2mm}
\noindent
\textbf{We propose to take advantage of the deepest of these opportunities to build $\sim 150\ {\rm arcmin^2}$ of deep F200W$=29.15-29.6$ $1-5\mu$m NIRCam imaging. This program - the \underline{Public Ultradeep Pure Parallel Imaging Extragalactic survey (PUPPIES)} will complement and expand the existing CEERS program by providing $0.2-0.6$ mag deeper imaging over a similar or larger area.}
