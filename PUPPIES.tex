...
\begin{SCfigure}
    \includegraphics[width=0.6\textwidth]{figs/LF_evo.pdf}
      \caption{\protect\rule{0ex}{5ex} Predicted constraints on the luminosity function from PUPPIES and WAFLS from $z=9\to 12$. }
      \vspace{-10mm}
\end{SCfigure}
...
\begin{SCfigure}
    \includegraphics[width=0.6\textwidth]{figs/SED.pdf}
      \caption{\protect\rule{0ex}{10ex} The expected NIRCam fluxes of a $2\times 10^{8}\ {\rm M_{\odot}}$ star forming galaxies at $z=9$, $z=11$, and $z=13$.}
      \label{fig:SED}
\end{SCfigure}
